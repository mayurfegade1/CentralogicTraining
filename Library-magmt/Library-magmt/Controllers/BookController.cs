    ...
    public class BookController : ControllerBase
    {
        ...
        public async Task<IActionResult> AddBook(BookModel bookmodel)
        {
          ...
          /*  BookModel model = new BookModel();
           ...
           model.IsAvaliable=response.IsAvaliable;
            model.BookQuantity=response.BookQuantity;
*/
                //auto mapping
            ...
            catch (Exception ex)
            {
                ...
                {
            try {
                // var exbook = container.GetItemLinqQueryable<Task>(true).Where(q => q.UId == taskModel.UId && q.DocumentType == "student" && q.Archieved == false && q.Active == true).AsEnumerable().FirstOrDefault();
               ...
               // existingbook.Version = 1;
                ...
                /*  BookModel model = new BookModel();
                  ...
                  model.BookQuantity=existingbook.BookQuantity;

                  model.IsAvaliable=bookModel.IsAvaliable;    
*/
                //auto mapping
